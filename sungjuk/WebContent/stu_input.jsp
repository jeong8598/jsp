...
<body>
<form name="form" id="form" method="post" action="stu_input_ok.jsp" onsubmit="return check()">
<table width="800" align="center">
	...
	<tr>
		<td>도로명주소</td>
		<td><input type="text" id="roadAddrPart1" name="juso" style="width:85%"></td>
	
	</tr>
	<tr>
		<td>상세주소</td>
		<td>
			<input type="text" id="addrDetail" name="juso_etc" style="width:40%" value="">
